...
# CODE CUSTOMIZATION 01- Make the code insensitive to capitals. We don't want to skip kitten.JPG because we are searching for kitten.jgp. Think of the kittens!

# CODE CUSTOMIZATION 02- Make the script accept the pattern to search for, and where to search, as an argument that is passed when the script is run. Then eliminate the prompts from the user. Be sure to include instructions on how to pass arguments. HINT: You need to check out argparse to do this! Go do that lab now if you're unsure how to complete this task, then return to this challenge. We promise it will still be here :p
